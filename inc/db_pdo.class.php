...
class db_pdo
{
	...
	public function DBUpdateNazvu($table_name, $nazev, $autor, $nadpis)
    {
        ...
        $query = "update $table_name set  nazev = '$nazev' where autor_id = '$autor' AND nazev = '$nadpis';";
        //echo $query;
    ...
    public function DBUpdateClanku($table_name, $clanek, $autor, $nadpis)
    {
        ...
        $query = "update $table_name set  abstrakt = '$clanek' where autor_id = '$autor' AND nazev = '$nadpis';";
        //echo $query;
    ...
    public function DBUpdateHodnoceni($table_name, $uzivatel, $clanek, $body1, $body2, $body3, $recenzent)
    {
        ...
        $query = "update $table_name set  body1 = '$body1', body2 = '$body2', body3 = '$body3', hodnoceno = '$hodnoceno' where uzivatel_id_uzivatel = '$uzivatel' AND clanky_id_clanky = '$clanek' AND id_recenzenta = $recenzent;";
        //echo $query;
    ...
    public function DBUpdateSchvaleno($table_name, $autor, $nadpis)
    {
        ...
        $query = "update $table_name set  schvaleno = 'ANO' where autor_id = '$autor' AND nazev = '$nadpis';";
        //echo $query;
